...
function surveyRenderQuestion(s, options) {
  ...
  if (options.question.name == "permission_from_parents_or_guardians") {
    ...
    const parent = document.querySelector(
      '[title="You confirm your child/ward has read or had the"]'
    );
    ...
    a.target = "_blank";
    span.innerText =
      " read to them and that he/she understands and agrees to participate";
    ...
    },
    {
      ...
      elements: [
        ...
        },
        {
          ...
          title:
            "Please ask your parent/guardian to complete the following section:",
      ...
      elements: [
        {
          ...
          name: "lab_test",
          title:
            "Have you had a SARS-CoV-2 (coronavirus or COVID-19) laboratory test?",
          isRequired: true,
          validators: [
            {
              type: "expression",
              text:
                "You cannot complete the survey if you haven't been tested!",
        ...
        },
        {
          ...
          choices: ["1-3", "4-6", "7-9", "10-12", "13-15", ">15"],
        },
      ],
    },
    {
      ...
      elements: [
        ...
        },
        {
          ...
          title:
            "Have you had direct contact with or are you taking care of a COVID-19 positive patient?",
          isRequired: true,
          choices: ["Yes", "No"],
        },
      ],
      ...
      elements: [
        {
          ...
          name: "lung_problems",
          title:
            "Which, if any, other lung problems do you have? (check all that apply)",
          hasOther: true,
        ...
        },
        {
          ...
          name: "symptoms",
          title:
            "Tick off all the symptoms that apply to you. I am experiencing:",
          choices: [
            "A cold",
            "A fever",
            "Diarrhoea",
        ...
        },
        {
          ...
          title: "Do you know your temperature or can you take it now?",
        ...
        },
        {
          ...
          name: "temp_panel",
          title:
            "Please adjust the slider to match your current temperature: *",
      ...
      elements: [
        {
          type: "microphone",
          description:
            "Please record a few seconds of yourself coughing using your device's microphone even if you currently don't have a cough. We know this may be very uncomfortable for you but the future development of the app hinges on this. To start/stop the recording, please tap/click on the green microphone button below. Please allow access to your device's microphone if prompted. The recording will automatically stop after 15 seconds. You may record yourself as many times as you like but keep in mind, only your last recording will be submitted. Alternatively, you may upload a pre-recorded recording of yourself coughing. You may listen to your recording by tapping/clicking on the play button.",
          name: "microphone",
          hideNumber: true,
